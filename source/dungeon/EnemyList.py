...
def create_sprite(super_tile, kind, sub_type, layer, tile_x, tile_y, region=None,
                  drops_item=False, drop_item_kind=None, fix=False, bonk=False, water=False, embed=False, never_drop=False):
...
def init_vanilla_sprites():
    ...
    create_sprite(0x0120, EnemySprite.GoodBee, 0x00, 0, 0x17, 0x07, bonk=True)
