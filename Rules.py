...
def global_rules(world, player):
    ...
    for location in world.get_locations():
        if location.player != player or not location.parent_region or location.parent_region.type == RegionType.LightWorld or location.parent_region.type == RegionType.DarkWorld:
            forbid_item(location, 'Teleporter', player)
        if location.name.endswith("- Boss") or location.name.endswith("- Prize"):
            forbid_item(location, 'Teleporter', player)
    ...
    set_rule(world.get_entrance('Light World Bomb Hut', player), lambda state: state.can_pass_bushes(player))
    set_rule(world.get_entrance('Bush Covered House', player), lambda state: state.can_pass_bushes(player))
    set_rule(world.get_entrance('Lost Woods Hideout Drop', player), lambda state: state.can_pass_bushes(player))
    set_rule(world.get_entrance('North Fairy Cave Drop', player), lambda state: state.can_pass_bushes(player))
    set_rule(world.get_entrance('Hyrule Castle Secret Entrance Drop', player), lambda state: state.can_pass_bushes(player))
    set_rule(world.get_entrance('Hyrule Castle Secret Entrance Exit', player), lambda state: state.can_pass_bushes(player))
    set_rule(world.get_entrance('Potion Shop Area', player), lambda state: state.can_pass_bushes(player) or state.has('Flippers', player) or state.has('Hookshot', player))
    ...
    set_rule(world.get_location('Bottle Merchant', player), lambda state: state.can_pass_bushes(player))
    ...
    set_rule(world.get_location('Sunken Treasure', player), lambda state: state.can_reach('Dam', 'Region', player))
    ...
    set_rule(world.get_entrance('Desert Palace Stairs', player), lambda state: state.has_Book(player))
    ...
    set_rule(world.get_entrance('Two-Way Mirror Spot', player), lambda state: state.has_TwoWay_Mirror(player))
    set_rule(world.get_entrance('Death Mountain Two-Way Mirror Spot', player), lambda state: state.has_TwoWay_Mirror(player))
    ...
    set_rule(world.get_location('Flute Spot', player), lambda state: state.has('Shovel', player) and state.can_pass_bushes(player))
    ...
    set_rule(world.get_location('Missing Smith', player), lambda state: state.has('Get Frog', player)) # Can S&Q with smith
    ...
    set_rule(world.get_location('Sahasrahla\'s Hut - Left', player), lambda state: state.can_pass_pots(player))
    set_rule(world.get_location('Sahasrahla\'s Hut - Middle', player), lambda state: state.can_pass_pots(player))
    set_rule(world.get_location('Sahasrahla\'s Hut - Right', player), lambda state: state.can_pass_pots(player))
    set_rule(world.get_location('Graveyard Cave', player), lambda state: state.can_pass_pots(player))
    set_rule(world.get_location('Cave 45', player), lambda state: state.can_pass_pots(player))
    set_rule(world.get_location('Kakariko Well - Top', player), lambda state: state.can_pass_pots(player))
    set_rule(world.get_location('Blind\'s Hideout - Top', player), lambda state: state.can_pass_pots(player))
    set_rule(world.get_location('Paradox Cave Upper - Left', player), lambda state: state.can_pass_pots(player))
    set_rule(world.get_location('Paradox Cave Upper - Right', player), lambda state: state.can_pass_pots(player))
    set_rule(world.get_location('Paradox Cave Lower - Far Left', player), lambda state: state.has_Book(player))
    set_rule(world.get_location('Paradox Cave Lower - Left', player), lambda state: state.has_Book(player))
    set_rule(world.get_location('Paradox Cave Lower - Middle', player), lambda state: state.has_Book(player))
    set_rule(world.get_location('Paradox Cave Lower - Right', player), lambda state: state.has_Book(player))
    set_rule(world.get_location('Paradox Cave Lower - Far Right', player), lambda state: state.has_Book(player))
    ...
    set_rule(world.get_entrance('Agahnim 1', player), lambda state: state.has_sword(player) and state.can_pass_pots(player) and state.has_key('Small Key (Agahnims Tower)', player, 2))
    ...
    set_rule(world.get_location('Ether Tablet', player), lambda state: state.has_Book(player) and state.has_beam_sword(player))
    ...
    set_rule(world.get_location('Bombos Tablet', player), lambda state: state.has_Book(player) and state.has_beam_sword(player) and state.has_Mirror(player))
    ...
    set_rule(world.get_entrance('Skull Woods First Section Hole (North)', player), lambda state: state.has_Pearl(player) and state.can_pass_bushes(player)) # bunny cannot lift bush
    set_rule(world.get_entrance('Skull Woods Second Section Hole', player), lambda state: state.has_Pearl(player) and state.can_pass_bushes(player)) # bunny cannot lift bush
    ...
    set_rule(world.get_entrance('Fairy Ascension Cave (Bottom)', player), lambda state: state.can_pass_pots(player))
    ...
    for location in ['Eastern Palace - Compass Chest', 'Eastern Palace - Big Chest', 'Eastern Palace - Cannonball Chest',
                     'Eastern Palace - Big Key Chest', 'Eastern Palace - Map Chest', 'Eastern Palace - Boss', 'Eastern Palace - Prize']:
        add_rule(world.get_location(location, player), lambda state: state.can_pass_pots(player))
    ...
    for location in ['Desert Palace - Map Chest', 'Desert Palace - Big Chest', 'Desert Palace - Boss', 'Desert Palace - Prize']:
        add_rule(world.get_location(location, player), lambda state: state.can_pass_pots(player))
    set_rule(world.get_entrance('Desert Palace Pots (Inner)', player), lambda state: state.can_pass_pots(player))
    set_rule(world.get_entrance('Desert Palace Pots (Outer)', player), lambda state: state.can_pass_pots(player))
    ...
    for location in ['Tower of Hera - Basement Cage', 'Tower of Hera - Map Chest', 'Tower of Hera - Big Key Chest',
                     'Tower of Hera - Compass Chest', 'Tower of Hera - Boss', 'Tower of Hera - Big Chest', 'Tower of Hera - Prize']:
        add_rule(world.get_location(location, player), lambda state: state.has_Book(player))
    ...
    set_rule(world.get_entrance('Swamp Palace (Center)', player), lambda state: state.has('Hammer', player)) # also requires can_pass_pots, which having hammer guarantees
    ...
    set_rule(world.get_location('Swamp Palace - West Chest', player), lambda state: state.has_Book(player))
    set_rule(world.get_location('Swamp Palace - Big Key Chest', player), lambda state: state.has_Book(player))
    if world.accessibility != 'locations':
    ...
    set_rule(world.get_entrance('Thieves Town Big Key Door', player), lambda state: state.has('Big Key (Thieves Town)', player) and state.has('Small Key (Thieves Town)', player) or state.can_pass_pots(player))
    ...
    for location in ['Skull Woods - Big Chest', 'Skull Woods - Pot Prison', 'Skull Woods - Pinball Room',
                     'Skull Woods - Big Key Chest', 'Skull Woods - Boss', 'Skull Woods - Prize']:
        add_rule(world.get_location(location, player), lambda state: state.can_pass_pots(player))

    set_rule(world.get_entrance('Ice Palace Entrance Room', player), lambda state: state.can_melt_things(player))
    set_rule(world.get_entrance('Ice Palace (Back)', player), lambda state: state.can_pass_pots(player) and state.has_Book(player))
    ...
    for location in ['Misery Mire - Compass Chest', 'Misery Mire - Main Lobby', 'Misery Mire - Big Key Chest',
                     'Misery Mire - Spike Chest', 'Misery Mire - Boss', 'Misery Mire - Prize']:
        add_rule(world.get_location(location, player), lambda state: state.can_pass_pots(player))

    for location in ['Misery Mire - Map Chest', 'Misery Mire - Compass Chest', 'Misery Mire - Main Lobby',
                     'Misery Mire - Boss', 'Misery Mire - Prize']:
        add_rule(world.get_location(location, player), lambda state: state.has_Book(player))

    set_rule(world.get_entrance('Turtle Rock Entrance Gap', player), lambda state: state.has('Cane of Somaria', player) and state.can_pass_pots(player))
    set_rule(world.get_entrance('Turtle Rock Entrance Gap Reverse', player), lambda state: state.has('Cane of Somaria', player) and state.can_pass_pots(player))
    ...
    set_rule(world.get_location('Turtle Rock - Chain Chomps', player), lambda state: state.has_Book(player))

    set_rule(world.get_location('Turtle Rock - Big Key Chest', player), lambda state: state.has_Book(player))
    ...
    set_rule(world.get_location('Turtle Rock - Crystaroller Room', player), lambda state: state.has_Book(player))
    set_rule(world.get_entrance('Turtle Rock Ledge Exit (West)', player), lambda state: state.can_pass_pots(player))
    set_rule(world.get_entrance('Turtle Rock (Dark Room) (North)', player), lambda state: state.has('Cane of Somaria', player))
    set_rule(world.get_entrance('Turtle Rock (Dark Room) (South)', player), lambda state: state.has('Cane of Somaria', player) and state.can_pass_pots(player))
    ...
    set_rule(world.get_entrance('Turtle Rock (Trinexx)', player), lambda state: state.has_key('Small Key (Turtle Rock)', player, 4) and state.has('Big Key (Turtle Rock)', player) and state.has('Cane of Somaria', player) and state.has_Book(player))
    ...
    set_rule(world.get_location('Palace of Darkness - Shooter Room', player), lambda state: state.can_pass_pots(player))
    ...
    set_rule(world.get_entrance('Palace of Darkness Big Key Door', player), lambda state: state.has_key('Small Key (Palace of Darkness)', player, 6) and state.has('Big Key (Palace of Darkness)', player) and state.can_shoot_arrows(player) and state.has('Hammer', player) and state.has_Book(player)) # also requires can_pass_pots, but hammer requirement necessitates that
    set_rule(world.get_entrance('Palace of Darkness (North)', player), lambda state: state.has_key('Small Key (Palace of Darkness)', player, 4) and state.can_pass_pots(player))
    ...
    set_rule(world.get_entrance('Ganons Tower (Tile Room)', player), lambda state: state.has('Cane of Somaria', player) and state.can_pass_pots(player))
    ...
    set_rule(world.get_entrance('Ganons Tower (Double Switch Room)', player), lambda state: state.has_key('Small Key (Ganons Tower)', player, 2) and state.has_Book(player))
    ...
    set_rule(world.get_entrance('Ganons Tower Big Key Door', player), lambda state: state.has('Big Key (Ganons Tower)', player) and state.can_shoot_arrows(player) and state.has_Book(player) and state.can_pass_pots(player))
...
def swordless_rules(world, player):
    ...
    set_rule(world.get_location('Ether Tablet', player), lambda state: state.has_Book(player) and state.has('Hammer', player))
    ...
    set_rule(world.get_location('Bombos Tablet', player), lambda state: state.has_Book(player) and state.has('Hammer', player) and state.has_Mirror(player))    
...
def set_trock_key_rules(world, player):
    ...
    # Check if each of the four main regions of the dungeon can be reached. The previous code section prevents key-costing moves within the dungeon.
    ...
    if can_reach_back:
        add_rule(world.get_location('Turtle Rock - Big Key Chest', player), lambda state: (state.has_key('Small Key (Turtle Rock)', player, 4) or item_name(state, 'Turtle Rock - Big Key Chest', player) == ('Small Key (Turtle Rock)', player)))
        ...
        add_rule(world.get_location('Turtle Rock - Big Key Chest', player), lambda state: state.has_key('Small Key (Turtle Rock)', player, tr_big_key_chest_keys_needed(state)))
        if world.accessibility != 'locations':
            set_always_allow(world.get_location('Turtle Rock - Big Key Chest', player), lambda state, item: item.name == 'Small Key (Turtle Rock)' and item.player == player)
        else:
            forbid_item(world.get_location('Turtle Rock - Big Key Chest', player), 'Small Key (Turtle Rock)', player)
