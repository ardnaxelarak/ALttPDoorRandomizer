...
RANDOMIZERBASEHASH = '1602d9fd14dd9132df15c71cc7e6fa21'
...
def patch_rom(world, rom, player, team, enemized, is_mystery=False):
    ...
    if ((world.collection_rate[player] or world.goal[player] == 'completionist')
       and world.goal[player] not in ['triforcehunt', 'trinity', 'z1', 'ganonhunt']):
    ...
    if world.swords[player] in ['swordless', 'swordless_b']:
        ...
        rom.write_byte(0x18002F, 0x81)  # special bombs
        rom.initial_sram.set_swordless_curtains()  # open curtains
        rom.write_byte(0x180041, 0x02)  # swordless medallions (always)
    ...
    elif world.goal[player] in ['ganonhunt', 'z1']:
    ...
    # maps showing crystals on overworld
    if world.mapshuffle[player]:
        rom.write_byte(0x18003B, 0x01)
    else:
        rom.write_byte(0x18003B, 0x00)
